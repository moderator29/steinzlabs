...
export const launchRadarHowItWorks: HowItWorksContent = {
  title: 'Launch Radar',
  tagline: 'The freshest token launches that clear a real quality bar, so the handful worth watching rises out of the thousands of new pairs.',
  howItWorks: [
    'Thousands of new pairs are created every day, and the overwhelming majority are dead on arrival, so the radar starts from the live new-pair feed and immediately filters out the noise.',
    'A token only appears if it clears a real quality bar: it was first seen inside the window you choose, it holds genuine liquidity rather than a dust pool, and it has actual trading volume rather than zero activity.',
  ...
  whatsNew: [
    {
      date: 'July 2026',
      tag: 'NEW',
      text: 'Launch Radar launched: a quality-filtered shortlist of the freshest token launches with real liquidity and trading, a HOT velocity badge, and one-tap Token X-Ray diligence.',
    },
  ],
};
