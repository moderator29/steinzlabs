  ...
  const img = (
    <img
      ...
      style={{
        ...
        // and round-friendly). Chosen layers extra gold trim on top of the
        // same base shape so the silhouette is consistent across profile,
        // dashboard Welcome card, sidebar, whispers, whale tracker chip.
        borderRadius: '50%',
        outline: v.goldTrim
    ...
    <span ref={wrapRef} className="relative inline-flex items-center" style={{ lineHeight: 0 }}>
      ...
      {open && (
        <span
          ...
          className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-[240px] max-w-[80vw] rounded-xl border border-white/10 bg-[#0b1022]/95 backdrop-blur px-3 py-2.5 text-start shadow-2xl"
