...
import type { OrderBookData } from '@/lib/market/types';
...
export function TradeTerminal({
  ...
  // Real per-trade tape — the same hook the live coin page uses, now backed
  // by GeckoTerminal's pool /trades endpoint (real swaps, real maker
  // addresses). Replaces the old synthetic loop that fabricated entries with
  // random wallet hex from DexScreener's aggregate hourly counts.
  const { trades: recentTrades } = useRecentTrades(pairAddress ?? null, chain);
