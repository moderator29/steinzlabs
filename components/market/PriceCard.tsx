 ...
 * supply, FDV, % unlocked) are hidden when absent rather than faked.
 */
...
export function PriceCard(props: PriceCardProps) {
  ...
  return (
    <div className="w-full rounded-xl border border-[#1E2433] bg-[#0D1117] p-4 sm:p-5">
      {/* Header */}
      <div className="flex items-start justify-between gap-3">
        ...
        {trusted && (
          <span className="inline-flex items-center gap-1 rounded-lg border border-[#10B981]/30 bg-[#10B981]/10 px-2 py-1 text-[11px] font-semibold text-[#10B981]">
            <ShieldCheck size={13} />
            Trusted
          </span>
        )}
      ...
      <div className="mt-3 flex items-end justify-between gap-3">
        ...
        <span className="rounded-md border border-[#1E2433] px-2 py-0.5 text-[11px] text-gray-400">24h</span>
      </div>
