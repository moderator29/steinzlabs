...
export function SignalChip({ signal }: { signal?: number | null }) {
  ...
  return (
    <span
      title={`Signal score ${s}/100`}
      className="inline-flex items-center gap-0.5 rounded-full border border-[#0066FF]/30 bg-[#0066FF]/10 px-1.5 py-[1px] text-[10px] font-semibold text-[#8fb6ff] tabular-nums leading-none"
    >
