...
export function FeatureCard({
  ...
  return (
    <div
      className="relative overflow-visible rounded-3xl p-6 md:p-7 flex flex-col gap-4"
    ...
    >
      ...
      <div>
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center relative overflow-hidden"
          ...
          <div className="absolute top-1.5 left-2 w-9 h-4 rounded-full"
      ...
      <div>
        ...
        <p className="text-white/75 text-[13px] leading-relaxed">{description}</p>
      </div>
