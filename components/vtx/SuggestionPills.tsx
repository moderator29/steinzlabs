    ...
    <div className="flex flex-wrap gap-2 mt-3">
      {suggestions.slice(0, 4).map((s, i) => (
        <button
          key={`${s}-${i}`}
          onClick={() => onPick(s)}
          className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full border border-white/10 bg-white/[0.03] hover:border-[#0066FF]/40 hover:bg-[#0066FF]/[0.08] text-[12px] text-slate-200 hover:text-white transition-all"
          style={{
