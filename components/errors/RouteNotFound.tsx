  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-[#141824] border border-[#1E2433] rounded-xl p-6 space-y-4 text-center">
        <div className="w-12 h-12 rounded-full bg-[#0066FF]/10 flex items-center justify-center mx-auto">
        ...
        <div className="flex gap-2 justify-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 bg-[#0066FF] hover:bg-[#0918D0] rounded-lg text-sm font-semibold text-white transition-colors"
          >
