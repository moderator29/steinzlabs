  ...
  return (
    <section id="wallet-intelligence" className="mb-16 scroll-mt-20">
      ...
      <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-8 mt-3">
        STEINZ LABS turns raw wallet addresses into complete behavioral profiles. Understand how any wallet trades, how it performs, what category it falls into, and whether it's connected to other known wallets — all from one lookup.
      </p>
