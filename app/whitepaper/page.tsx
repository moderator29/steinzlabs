      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 lg:py-16 lg:flex lg:gap-14">
        ...
        <main className="flex-1 min-w-0 max-w-3xl">
          ...
          <WpSection id="summary" n="01" title="Executive Summary">
            <p>NAKA LABS is an on-chain intelligence operating system built for the next generation of crypto participants. It aggregates real-time data across 12+ blockchains, applies Claude AI to surface actionable signals, and delivers a unified experience covering intelligence, security, trading, and portfolio management — all in a browser-based platform requiring no installation.</p>
          ...
          <WpSection id="security" n="06" title="Security Layer">
            <p>Security is not a feature in NAKA LABS — it is the default operating mode. Every token interaction is scanned before execution. Every approval is monitored. Every domain is checked in real time.</p>
            ...
            <Callout color="#EF4444" icon={AlertTriangle} title="Security disclaimer">
              All security tools provide advisory information based on on-chain data. They do not guarantee protection from loss. NAKA LABS is not responsible for trading decisions made using platform data. Always conduct independent research.
            </Callout>
          </WpSection>

          {/* Section 07 — Trading */}
          <WpSection id="trading" n="07" title="Trading Suite">
            <p>NAKA LABS provides a complete set of trading tools — from simple swaps to fully automated execution. Every tool is designed with security-first principles: no trade executes without a pre-flight safety check.</p>
            <h3 className="text-base font-bold text-white mt-6 mb-3">Multi-Chain Swap Engine</h3>
            <p>Powered by Jupiter (Solana) and 0x Protocol (EVM), the swap engine routes each trade across all available DEX liquidity to find the best execution price. Users swap directly from the NAKA LABS interface without leaving the platform. Each swap is preceded by a Trust Score check on the destination token.</p>
          ...
          <WpSection id="smart-money" n="08" title="Smart Money & Whale Tracking">
            <p>Understanding what professional capital is doing is one of the most powerful edges available in on-chain markets. NAKA LABS tracks 1,000+ high-performance wallets across 10 chains in real time, classifies them by behavior, and surfaces their moves as they happen.</p>
          ...
          <WpSection id="portfolio" n="09" title="Portfolio & Analytics">
            <p>Portfolio management in NAKA LABS is designed to be fully non-custodial and read-only. You add wallet addresses — never private keys — and the platform builds a unified financial picture across every chain.</p>
            ...
            <p>In-depth analysis of protocols, sectors, and on-chain narratives. NAKA LABS publishes original research, and Pro subscribers can submit analyses for community review and publication. Research is cited with on-chain data links so every claim is verifiable.</p>
          </WpSection>

          {/* Section 10 — Community */}
          <WpSection id="community" n="10" title="Community & Discovery">
            <p>NAKA LABS extends beyond individual analysis to community-level intelligence — connecting builders, traders, and researchers in a verifiable, on-chain-first ecosystem.</p>
            <FeatureGrid items={[
              ...
              { icon: Star, color: '#F59E0B', title: 'Project Discovery', desc: 'A curated pipeline of early-stage projects vetted by the NAKA LABS team and community. Each project carries a Trust Score and on-chain diligence report.' },
              { icon: Zap, color: '#10B981', title: 'Launchpad', desc: 'A trust-scored token launch platform. Projects launching through NAKA LABS undergo security auditing before listing, giving early participants a meaningful safety edge.' },
          ...
          <WpSection id="economics" n="11" title="Platform Economics">
            <p>NAKA LABS generates revenue through three mechanisms, all designed to align platform incentives with user success.</p>
            <div className="space-y-3 my-5">
              {[
                ...
                { title: 'DEX swap fees', color: '#10B981', desc: 'A small fee on swaps executed through the NAKA LABS interface. This fee is disclosed upfront and included in the displayed quote. No hidden charges.' },
                { title: 'Launchpad participation', color: '#F59E0B', desc: 'Projects launching through the NAKA LABS Launchpad pay a listing fee that covers security auditing and community promotion. No ongoing royalties.' },
              ].map(r => (
          ...
          <WpSection id="roadmap" n="12" title="Roadmap">
            <p>NAKA LABS is actively developed. The following roadmap reflects planned capability expansions — timelines are targets, not guarantees.</p>
            <div className="space-y-3 my-5">
              {[
          ...
          <div className="pt-8 border-t border-white/[0.06]">
            ...
            <p className="text-xs text-gray-700 mt-4 leading-relaxed">
              This whitepaper is for informational purposes only. Nothing herein constitutes financial advice, investment advice, or a solicitation to invest. Crypto assets are highly volatile and speculative. Past performance of platform tools does not guarantee future results. Use of NAKA LABS is subject to our Terms of Service.
            </p>
          </div>
        </main>
      </div>
