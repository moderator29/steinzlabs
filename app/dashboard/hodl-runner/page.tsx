  ...
  useEffect(() => {
    ...
    const spawnObstacle = () => {
      ...
      if (type === 'candle') {
        ...
        ob = { x: W + 20, y: GROUND_Y - 8, width: 50, height: 8, type, color: '#6366F1', passed: false };
      }
    ...
    const jump = () => {
      ...
      if (!game.player.jumping) {
        ...
        addParticles(game.player.x, game.player.y + PLAYER_H, '#00D4AA', 5);
      } else if (!game.player.doubleJump) {
        game.player.vy = -10;
        game.player.doubleJump = true;
        addParticles(game.player.x, game.player.y + PLAYER_H, '#6366F1', 5);
      }
    };
    ...
    const drawMechRunner = () => {
      ...
      visorGrad.addColorStop(0, '#00D4AA');
      visorGrad.addColorStop(0.5, '#6366F1');
      visorGrad.addColorStop(1, '#00D4AA');
      ...
      if (p.jumping) {
        ...
        if (game.frameCount % 4 === 0) {
          game.particles.push({
            ...
            life: 8, maxLife: 8, color: '#00D4AA', size: 1.5,
          });
        }
      }
    ...
    const gameLoop = () => {
      ...
      if (game.alive) {
        ...
        if (died) {
          ...
          addParticles(game.player.x, game.player.y + PLAYER_H / 2, '#00D4AA', 8);
      ...
      if (game.alive && game.player.jumping) {
        if (game.frameCount % 3 === 0) {
          game.particles.push({
            ...
            life: 15, maxLife: 15, color: '#00D4AA', size: 2,
          });
        }
      }
    ...
    return (
      <div className="fixed inset-0 z-50 bg-[#060A12]">
        ...
        <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-3 py-2 pointer-events-none" style={{ zIndex: 10 }}>
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-[#00D4AA]/20 px-3 py-1.5">
            <span className="text-sm font-bold text-[#00D4AA]">{liveDistance}m</span>
          </div>
        </div>
            ...
            <div className="bg-[#0a0e1a]/95 backdrop-blur-md border border-[#EF4444]/30 rounded-3xl p-6 mx-4 max-w-sm w-full text-center animate-in fade-in zoom-in-95 duration-300">
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                <div className="bg-[#060A12] rounded-xl p-2.5">
                  ...
                  <div className="text-base font-bold text-[#00D4AA]">{finalScore.toLocaleString()}</div>
                </div>
                <div className="bg-[#060A12] rounded-xl p-2.5">
              ...
              {rank > 0 && (
                <div className="bg-[#060A12] rounded-xl p-2.5 mb-4 flex items-center justify-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-[#6366F1]">{personalBest.toLocaleString()}</div>
                  </div>
                </div>
              )}
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#00D4AA] to-[#6366F1] py-3 rounded-xl text-sm font-bold hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                >
      ...
      <div className="px-4 pt-4 pb-2">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <Gamepad2 className="w-5 h-5 text-[#00D4AA]" />
        ...
        {gameState === 'login' && (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-[#00D4AA]/5 to-[#6366F1]/5 rounded-2xl border border-[#1a1f2e] p-6 text-center">
              <div className="w-24 h-24 mx-auto mb-4 relative">
                <div className="w-24 h-24 bg-gradient-to-br from-[#0d1333] to-[#1a2555] rounded-2xl flex items-center justify-center shadow-lg shadow-[#00D4AA]/20 border border-[#00D4AA]/30 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#00D4AA]/10 to-transparent" />
                  <div className="relative">
                    <div className="w-10 h-12 relative">
                      <div className="absolute w-8 h-7 bg-gradient-to-b from-[#1a2555] to-[#0d1333] rounded-t-lg left-1 top-0 border border-[#00D4AA]/40" />
                      <div className="absolute w-6 h-2.5 bg-gradient-to-r from-[#00D4AA] via-[#6366F1] to-[#00D4AA] rounded left-2 top-1.5 shadow-[0_0_8px_rgba(0,229,255,0.6)]" />
                      <div className="absolute w-10 h-8 bg-gradient-to-b from-[#1a2555] to-[#0d1333] rounded top-5 border border-[#00D4AA]/30" />
                      <div className="absolute w-3 h-3 bg-[#00D4AA]/30 rounded-full left-3.5 top-7 border border-[#00D4AA]/50 flex items-center justify-center">
                        <span className="text-[5px] text-[#00D4AA] font-bold">W</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-16 h-3 bg-[#00D4AA]/10 rounded-full blur-sm" />
              </div>
              ...
              <div className="flex items-center justify-center gap-4 mt-3">
                <div className="text-center">
                  ...
                  <div className="text-[10px] text-[#00D4AA] font-semibold">Tap / Space</div>
                </div>
                <div className="w-px h-6 bg-[#1a1f2e]" />
                <div className="text-center">
                  <div className="text-[8px] text-gray-600 uppercase">Double Jump</div>
                  <div className="text-[10px] text-[#6366F1] font-semibold">Tap Again</div>
                </div>
                <div className="w-px h-6 bg-[#1a1f2e]" />
                <div className="text-center">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  maxLength={20}
                  className="w-full bg-[#0f1320] border border-[#1a1f2e] rounded-xl px-4 py-3.5 text-sm text-white focus:outline-none focus:border-[#00D4AA]/50 placeholder:text-gray-700"
                  autoFocus
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#00D4AA] to-[#6366F1] py-4 rounded-2xl text-base font-bold hover:opacity-90 transition-opacity disabled:opacity-30 flex items-center justify-center gap-2 shadow-lg shadow-[#00D4AA]/20"
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#0f1320] rounded-xl p-3 border border-[#1a1f2e] text-center">
                ...
                <div className="text-base font-bold text-[#00D4AA]">{stats.totalPlayers}</div>
              </div>
              <div className="bg-[#0f1320] rounded-xl p-3 border border-[#1a1f2e] text-center">
            ...
            <div className="bg-[#0f1320] rounded-2xl border border-[#1a1f2e] p-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  { label: 'Rug Pulls', desc: 'Jump over', color: '#6366F1', icon: '🕳️' },
                ].map(o => (
            ...
            <div className="bg-gradient-to-br from-[#EF4444]/5 to-[#F59E0B]/5 rounded-2xl border border-[#EF4444]/15 p-6 text-center">
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                <div className="bg-[#060A12] rounded-xl p-3">
                  ...
                  <div className="text-lg font-bold text-[#00D4AA]">{finalScore.toLocaleString()}</div>
                </div>
                <div className="bg-[#060A12] rounded-xl p-3">
              ...
              {rank > 0 && (
                <div className="bg-[#060A12] rounded-xl p-3 mb-4 flex items-center justify-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-base font-bold text-[#6366F1]">{personalBest.toLocaleString()}</div>
                  </div>
                </div>
              )}
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={startGame}
                  className="bg-gradient-to-r from-[#00D4AA] to-[#6366F1] py-3.5 rounded-xl text-sm font-bold hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                >
        ...
        {gameState === 'leaderboard' && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setGameState('login')} className="text-[10px] text-[#00D4AA] font-semibold">Back to Game</button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-[#0f1320] rounded-xl p-3 border border-[#1a1f2e] text-center">
                ...
                <div className="text-base font-bold text-[#6366F1]">{stats.totalGamesPlayed}</div>
              </div>
              <div className="bg-[#0f1320] rounded-xl p-3 border border-[#1a1f2e] text-center">
              ...
              {leaderboard.length === 0 ? (
                ...
                <div className="divide-y divide-[#1a1f2e]/50">
                  {leaderboard.map((entry, i) => (
                    <div key={entry.id} className={`px-4 py-3 flex items-center gap-3 ${entry.username.toLowerCase() === username.toLowerCase() ? 'bg-[#00D4AA]/[0.03]' : ''}`}>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5">
                          ...
                          {entry.username.toLowerCase() === username.toLowerCase() && (
                            <span className="text-[7px] px-1 py-0.5 rounded bg-[#00D4AA]/10 text-[#00D4AA] font-bold">YOU</span>
                          )}
                        </div>
            ...
            <button
              onClick={startGame}
              disabled={!username.trim()}
              className="w-full bg-gradient-to-r from-[#00D4AA] to-[#6366F1] py-3.5 rounded-2xl text-sm font-bold hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
