...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  DexScreener: 'bg-[#0066FF]/20 text-[#0066FF]',
      ...
      <div className="px-4 pt-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between gap-2 mb-1">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <RotateCcw className={`w-4 h-4 text-[#0066FF] transition-transform ${loading ? 'animate-spin' : 'group-hover:rotate-180 duration-500'}`} />
            </button>
          </div>
        </div>
        ...
        {loading && projects.length === 0 ? (
          <div className="text-center py-20">
            <RotateCcw className="w-8 h-8 text-[#0066FF] mx-auto mb-3 animate-spin" />
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="w-full py-1.5 rounded-lg border border-[#0066FF]/30 text-[#0066FF] text-[11px] font-semibold hover:bg-[#0066FF]/10 transition-colors flex items-center justify-center gap-1"
      >
