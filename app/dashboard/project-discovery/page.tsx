        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-gradient-to-r from-[#0A1EFF] to-[#7C3AED] rounded-lg text-[11px] font-bold flex items-center gap-1 hover:opacity-90 transition-opacity"
            >
            ...
            >
              <RotateCcw className={`w-4 h-4 text-[#0A1EFF] transition-transform ${loading ? 'animate-spin' : 'group-hover:rotate-180 duration-500'}`} />
            </button>
          </div>
        </div>
          ...
          {CHAINS.map((c) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[10px] font-semibold whitespace-nowrap transition-colors ${
                activeChain === c.id
                  ? 'bg-gradient-to-r from-[#0A1EFF] to-[#7C3AED] text-white'
  ...
  return (
    <div className={`glass rounded-xl p-4 border transition-all hover:scale-[1.02] ${
      project.pinned
        ...
        : 'border-white/10 hover:border-[#0A1EFF]/30'
    }`}>
      {project.pinned && (
      ...
      <a
        ...
        className="w-full py-1.5 rounded-lg border border-[#0A1EFF]/30 text-[#0A1EFF] text-[11px] font-semibold hover:bg-[#0A1EFF]/10 transition-colors flex items-center justify-center gap-1"
      >
      ...
      <div className="bg-[#111827] border border-white/10 rounded-2xl max-w-lg w-full max-h-[85vh] overflow-y-auto p-6" onClick={e => e.stopPropagation()}>
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            {previewUrl && (
              <a href={previewUrl} className="inline-flex items-center gap-2 px-4 py-2 bg-[#1A2235] border border-[#0A1EFF]/30 rounded-lg text-xs text-[#0A1EFF] hover:bg-[#0A1EFF]/10 transition-colors mb-3">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-2.5 bg-gradient-to-r from-[#0A1EFF] to-[#7C3AED] rounded-lg text-sm font-bold disabled:opacity-50 hover:opacity-90 transition-opacity"
            >
