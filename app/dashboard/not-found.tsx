  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-6">
      <div className="max-w-sm w-full text-center space-y-4">
        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[var(--nl-blue,#0A1EFF)]/15">
          <Compass className="w-6 h-6 text-[var(--nl-blue,#0A1EFF)]" />
        </div>
        <div>
        ...
        <div className="flex items-center justify-center gap-2">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[var(--nl-blue,#0A1EFF)] text-white text-sm font-semibold"
          >
