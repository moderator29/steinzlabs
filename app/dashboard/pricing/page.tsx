    ...
    <div className="min-h-screen bg-[#0A0E1A] text-white pt-32 pb-24 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-block px-4 py-2 bg-[#0A1EFF]/10 border border-[#0A1EFF]/30 rounded-full mb-6">
            <span className="text-[#0A1EFF] text-sm font-semibold">PRIVATE BETA ACCESS</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="glass rounded-2xl p-8 border border-white/10 hover:border-[#0A1EFF]/30 transition-all">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-[#0A1EFF] to-[#7C3AED] rounded-xl flex items-center justify-center">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-[#0A1EFF]">90% OFF - Beta Pricing</p>
            ...
            <button className="w-full bg-gradient-to-r from-[#0A1EFF] to-[#7C3AED] px-6 py-4 rounded-xl font-semibold text-lg hover:scale-105 transition-transform flex items-center justify-center gap-2">
        ...
        <div className="mt-12 max-w-2xl mx-auto glass rounded-xl p-6 border border-[#0A1EFF]/30 text-center">
          <p className="text-sm text-gray-300 leading-relaxed">
            <span className="font-semibold text-[#0A1EFF]">Beta users lock in this pricing forever.</span> Price increases to regular rates after beta ends. No credit card required during beta - pay with crypto only. Cancel anytime.
          </p>
        </div>
