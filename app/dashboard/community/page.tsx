  ...
  return (
    <div className="min-h-screen bg-[#0B0D14] text-white pt-32 pb-24 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="w-24 h-24 bg-gradient-to-br from-[#6366F1] to-[#00D4AA] rounded-3xl flex items-center justify-center mx-auto mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 text-left">
          <div className="glass rounded-xl p-6 border border-white/10">
            <MessageCircle className="w-10 h-10 text-[#00D4AA] mb-3" />
        ...
        <div className="glass rounded-2xl p-8 border border-[#00D4AA]/30 max-w-md mx-auto">
          <Bell className="w-8 h-8 text-[#00D4AA] mx-auto mb-4" />
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-[#111827] border border-white/10 rounded-lg px-4 py-3 focus:outline-none focus:border-[#00D4AA]/50 text-sm"
            />
            <button className="bg-gradient-to-r from-[#00D4AA] to-[#6366F1] px-6 py-3 rounded-lg font-semibold hover:scale-105 transition-transform">
              Notify Me
            </button>
          </div>
        </div>
