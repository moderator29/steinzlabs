      ...
      <div className="p-4 space-y-4">
        ...
        {loading && (
          <div className="text-center py-12">
            <Loader2 className="w-10 h-10 text-[#00D4AA] mx-auto mb-3 animate-spin" />
            ...
            <div className="glass rounded-xl p-4 border border-white/10">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#00D4AA]/20 to-[#6366F1]/20 rounded-full flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  { label: 'TX Count', value: walletData.txCount.toLocaleString(), icon: Activity, color: '#6366F1' },
                  { label: 'Tokens Held', value: walletData.holdings.length.toString(), icon: TrendingUp, color: '#00D4AA' },
                ...
                {walletData.holdings.length === 0 ? (
                  ...
                  walletData.holdings.slice(0, 10).map((h, i) => (
                    <div key={`${h.symbol}-${i}`} className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 bg-[#00D4AA]/10 rounded-full flex items-center justify-center text-[10px] font-bold text-[#00D4AA]">
                          {h.symbol.charAt(0)}
                        </div>
                        <div>
              ...
              {aiLoading ? (
                ...
                <>
                  ...
                  {aiAnalysis.recommendations && aiAnalysis.recommendations.length > 0 && (
                    <div>
                      <span className="text-[10px] text-[#00D4AA] font-semibold">Recommendations:</span>
                      <ul className="mt-1 space-y-0.5">
