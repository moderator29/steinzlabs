  ...
  return (
    <div className="min-h-screen bg-[#0B0D14] text-white pt-32 pb-24 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="w-24 h-24 bg-gradient-to-br from-[#10B981] to-[#00D4AA] rounded-3xl flex items-center justify-center mx-auto mb-6">
            ...
            {[
              ...
              <div key={s.step}>
                <div className="w-10 h-10 bg-[#00D4AA]/20 rounded-lg flex items-center justify-center mb-3">
                  <span className="text-[#00D4AA] font-bold">{s.step}</span>
                </div>
