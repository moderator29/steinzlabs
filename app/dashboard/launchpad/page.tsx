  ...
  return (
    <div className="min-h-screen text-white pb-20">
      ...
      <div className="p-4 space-y-4">
        <div className="nl-glass rounded-xl p-4 bg-gradient-to-r from-[#0066FF]/5 to-[#7C3AED]/5" style={{ boxShadow: '0 0 0 1px rgba(0,102,255,.4), 0 0 16px rgba(0,102,255,.18)' }}>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {filtered.map((project) => {
              ...
              return (
                <div key={project.id} className="nl-glass rounded-xl p-4 transition-all" style={{ boxShadow: '0 0 0 1px rgba(0,102,255,.4), 0 0 16px rgba(0,102,255,.18)' }}>
