...
export default function LaunchpadPage() {
  ...
  const statusColor = (status: string) => {
    ...
    if (status === 'funded' || status === 'completed') return 'bg-[#00D4AA]/20 text-[#00D4AA]';
    ...
    <div className="min-h-screen bg-[#0B0D14] text-white pb-20">
      ...
      <div className="p-4 space-y-4">
        <div className="glass rounded-xl p-4 border border-[#00D4AA]/20 bg-gradient-to-r from-[#00D4AA]/5 to-[#6366F1]/5">
          ...
          <Link href="/dashboard/builder-funding" className="inline-flex items-center gap-1 text-[11px] text-[#00D4AA] font-semibold hover:underline">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className="glass rounded-xl p-3 border border-white/10 text-center">
            <div className="text-lg font-bold text-[#00D4AA]">{stats.totalProjects}</div>
            <div className="text-[10px] text-gray-500">Projects</div>
          </div>
          <div className="glass rounded-xl p-3 border border-white/10 text-center">
            <div className="text-lg font-bold text-[#6366F1]">{stats.activeProjects}</div>
          ...
          <div className="space-y-3">
                ...
                <div key={project.id} className="glass rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-3">
                      <div className="w-11 h-11 bg-gradient-to-br from-[#00D4AA]/20 to-[#6366F1]/20 rounded-lg flex items-center justify-center relative">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="w-full bg-white/10 rounded-full h-2">
                      <div className="h-2 rounded-full bg-gradient-to-r from-[#00D4AA] to-[#6366F1]" style={{ width: `${Math.min(pct, 100)}%` }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-gray-500">
                    ...
                    <Link href="/dashboard/builder-funding" className="ml-auto text-[#00D4AA] font-semibold flex items-center gap-0.5">
            ...
            {filtered.length === 0 && (
              <div className="text-center py-12">
                ...
                <Link href="/dashboard/builder-funding" className="text-xs text-[#00D4AA] mt-2 inline-block hover:underline">
                  Submit your project
                </Link>
              </div>
            )}
