    ...
    <div className="min-h-screen bg-[#0B0D14] text-white pb-20">
      <div className="sticky top-0 z-40 glass backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center gap-3 px-4 h-14">
          ...
          <Fish className="w-5 h-5 text-[#00D4AA]" />
      ...
      <div className="p-4 space-y-4">
        ...
        {loading && events.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <button onClick={() => fetchWhaleData()} className="text-xs text-[#00D4AA] hover:underline">
              Try again
            </button>
          </div>
              ...
              return (
                <div key={i} className="glass rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {link ? (
                      <a href={link} target="_blank" rel="noopener noreferrer" className="text-[#00D4AA] hover:underline text-[10px] flex items-center gap-0.5">
