      ...
      <div className="sticky top-0 z-30 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <nav className="flex items-center gap-1.5 overflow-x-auto scrollbar-none -mx-1 px-1 min-w-0 flex-1">
            ...
            {/* Owner priority — Directory + Watchlist come FIRST (the two most-used
                surfaces), before the advanced "New" tools, so they're not hidden
                off-screen behind Convergence/Compare/Whale DNA/etc. */}
            <Link href="/dashboard/whale-tracker/directory" className="shrink-0 px-3 py-1.5 text-[11px] font-semibold rounded-lg text-white bg-[#0066FF]/15 border border-[#0066FF]/40 hover:border-[#0066FF]/60 transition-colors">Directory</Link>
            <Link href="/dashboard/whale-tracker/watchlist" className="shrink-0 px-3 py-1.5 text-[11px] font-semibold rounded-lg text-white bg-[#0066FF]/15 border border-[#0066FF]/40 hover:border-[#0066FF]/60 transition-colors">Watchlist</Link>
            ...
            <Link href="/dashboard/whale-tracker/lookalikes" className="shrink-0 px-3 py-1.5 text-[11px] font-semibold rounded-lg text-[#00C8FF] hover:text-white bg-[#0066FF]/10 border border-[#0066FF]/30 hover:border-[#0066FF]/50 transition-colors inline-flex items-center gap-1">Look-Alikes <span className="text-[8px] px-1 py-0.5 rounded bg-[#0066FF]/30 text-white uppercase font-bold">New</span></Link>
