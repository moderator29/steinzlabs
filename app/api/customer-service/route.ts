...
A: Yes. NAKA LABS is 100% non-custodial. We only READ public blockchain data. Your private keys never leave your wallet. We cannot move your funds.
...
A: A 0-100 rating NAKA LABS assigns to on-chain events, tokens, and wallets based on contract verification, liquidity, holder distribution, and developer history.

Q: Who is behind NAKA LABS?
A: NAKA LABS is an independent on-chain intelligence platform built for professional crypto analysts.
